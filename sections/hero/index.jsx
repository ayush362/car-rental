...
export const Hero = () => {
  return (
    <section className="container mx-auto flex justify-center lg:justify-between mt-40 items-center">
      <div className="flex items-center justify-center">
        <div className="flex flex-col gap-5 pl-16 lg:p-0 w-full py-5">
